...
function FooterLayoutDeleteAlertForm({ toggleModal, isOpen, handleAlertForm, clickedDeleteRowData }: Props) {
	return (
		<Dialog
			open={isOpen}
			onClose={toggleModal}
		>
			...
			<DialogContent>
				<DialogContentText className="text-[10px] sm:text-[12px] lg:text-[14px]">
					Are you sure you want to delete this Footer Layout ?
				</DialogContentText>
			</DialogContent>
...
export default FooterLayoutDeleteAlertForm;
