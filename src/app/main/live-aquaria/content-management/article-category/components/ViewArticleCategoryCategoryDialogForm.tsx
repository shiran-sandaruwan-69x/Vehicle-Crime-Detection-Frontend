...
import { CategoryFormData } from '../../../laq-master-data/category-nanagement/category-nanagement-types/CategoryManagementTypes';
import { MappedArticleCategory } from '../article-category-types/ArticleCategoryTypes';
import { updateArticleCategories } from '../../../../../axios/services/live-aquaria-services/article-services/ArticleServices';
import FormDropdown from "../../../../../common/FormComponents/FormDropdown";

interface Props {
	toggleModal: () => void;
	isOpen: boolean;
	clickedRowData: MappedArticleCategory;
	compType: string;
	getAllCategory: () => void;
}
...
function ViewArticleCategoryCategoryDialogForm({
	toggleModal,
	isOpen,
	clickedRowData,
	compType,
	...
	const onSubmit = async (values: CategoryFormData) => {
		...
		if (image) {
			try {
				const response = await updateArticleCategories(mediaData, id);
				getAllCategory();
		...
		>
			<DialogTitle className="pb-0">
				<h6 className="text-[10px] sm:text-[12px] lg:text-[14px] text-gray-600 font-400">
					{compType === 'view' ? 'View' : 'Edit'} Article Category
				</h6>
			</DialogTitle>
			<DialogContent>
				<Formik
					initialValues={{
						category: clickedRowData?.categoryName ? clickedRowData?.categoryName : '',
						aquaticType: clickedRowData?.aquatic_type ? clickedRowData?.aquatic_type : '',
						referenceName: clickedRowData?.referenceName ? clickedRowData?.referenceName : ''
					}}
...
export default ViewArticleCategoryCategoryDialogForm;
