...
import ArticleContentComp from './components/ArticleContentComp';
...
function ContactUsSubjectMaintenance() {
	...
	return (
		<div className="min-w-full max-w-[100vw]">
			<NavigationViewComp title="Content Management/ Contact Us Subject Maintenance" />
...
export default ContactUsSubjectMaintenance;
