...
interface Props {
	toggleModal: () => void;
	isOpen: boolean;
	clickedRowData: VediosLibraryInterface;
	handleAlertForm: () => void;
}

function VideoLibraryActiveAlertForm({ toggleModal, isOpen, clickedRowData, handleAlertForm }: Props) {
	return (
		<Dialog
			open={isOpen}
			onClose={toggleModal}
...
export default VideoLibraryActiveAlertForm;
