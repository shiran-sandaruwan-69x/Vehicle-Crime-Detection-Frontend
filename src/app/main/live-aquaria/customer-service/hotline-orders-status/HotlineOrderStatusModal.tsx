...
function HotlineOrderStatusModal({
  toggleModal,
  isOpen,
  selectedId,
  ...
  const fetchOrderClaim = async () => {
    setLoading(true);
    try {
      const response = await axios.get(`${ORDER_CLAIMS}/${selectedId}`);
        ...
        <Grid container spacing={2}>
          ...
          >
            ...
            >
              ...
              <CustomTab label='Claim Details' index={1} />
              <CustomTab label='Claim History Logs & Others' index={2} />
            </Tabs>
          </Grid>
          <Grid item md={12} sm={12} xs={12} className='!pt-0'>
            <CustomTabPanel value={value} index={0}>
              <CustomerClaimHistory toggleModal={toggleModal} claim={claim} />
            </CustomTabPanel>
            <CustomTabPanel value={value} index={1}>
              <ClaimDetails toggleModal={toggleModal} claim={claim} />
            </CustomTabPanel>
            <CustomTabPanel value={value} index={2}>
              <ClaimHistoryLog toggleModal={toggleModal} claim={claim} />
            </CustomTabPanel>
          </Grid>
        </Grid>
      </DialogContent>
...
export default HotlineOrderStatusModal;
