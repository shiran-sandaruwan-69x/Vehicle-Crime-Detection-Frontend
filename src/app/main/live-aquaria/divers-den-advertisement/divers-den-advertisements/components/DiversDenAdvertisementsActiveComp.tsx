...
function DiversDenAdvertisementsActiveComp({ clickedRowData, toggleModal, isOpen, handleAlertForm }: Props) {
	return (
		<Dialog
			open={isOpen}
			onClose={toggleModal}
...
export default DiversDenAdvertisementsActiveComp;
