...
function SneakPeekEmailDeleteAlertForm({ toggleModal, isOpen, handleAlertForm }: Props) {
	return (
		<Dialog
			open={isOpen}
			onClose={toggleModal}
		>
			...
			<DialogContent>
				<DialogContentText className="text-[10px] sm:text-[12px] lg:text-[14px]">
					Are you sure you want to delete this Sneak Peek Email?
				</DialogContentText>
			</DialogContent>
			<DialogActions>
				<Button
...
export default SneakPeekEmailDeleteAlertForm;
