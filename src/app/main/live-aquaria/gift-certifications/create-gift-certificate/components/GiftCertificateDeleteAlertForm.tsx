...
interface Props {
	toggleModal: () => void;
	isOpen: boolean;
	clickedRowData: GiftCertificatesInterface;
	handleAlertForm: () => void;
}

function GiftCertificateDeleteAlertForm({ toggleModal, isOpen, clickedRowData, handleAlertForm }: Props) {
	return (
		<Dialog
			open={isOpen}
			onClose={toggleModal}
...
export default GiftCertificateDeleteAlertForm;
