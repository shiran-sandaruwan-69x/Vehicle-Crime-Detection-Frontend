...
import { MappedAttribute } from '../attribute-types/AttributeTypes';
...
function NewAttributeActiveDialogForm({ toggleModal, isOpen, clickedRowData, handleAlertForm }: Props) {
	return (
		<Dialog
			open={isOpen}
			onClose={toggleModal}
...
export default NewAttributeActiveDialogForm;
