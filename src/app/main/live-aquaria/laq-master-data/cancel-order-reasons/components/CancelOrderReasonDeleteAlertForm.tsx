...
import { ReasonModifiedData } from '../cancel-order-reason-types/CancelOrderReasonTypes';
...
function CancelOrderReasonDeleteAlertForm({ toggleModal, isOpen, clickedRowData, handleAlertForm }: Props) {
	return (
		<Dialog
			open={isOpen}
			onClose={toggleModal}
		>
			...
			<DialogContent>
				<DialogContentText className="text-[10px] sm:text-[12px] lg:text-[14px]">
					Are you sure you want to delete this Cancel Order Reason?
				</DialogContentText>
			</DialogContent>
			<DialogActions>
				<Button
...
export default CancelOrderReasonDeleteAlertForm;
