...
import { FlattenedCategory } from '../category-nanagement-types/CategoryManagementTypes';
...
function CategoryActiveAlertForm({ toggleModal, isOpen, clickedRowData, handleAlertForm }: Props) {
	return (
		<Dialog
			open={isOpen}
			onClose={toggleModal}
...
export default CategoryActiveAlertForm;
