...
import { ItemDetailsModifiedData } from '../../etf-master-data/etf-master-data-types/ETFMasterDataTypes';
...
function CommonProductMasterFormActiveAlertForm({ toggleModal, isOpen, handleAlertForm, clickedRowData }: Props) {
	return (
		<Dialog
			open={isOpen}
			onClose={toggleModal}
		>
			...
			<DialogContent>
				<DialogContentText>
					...
					<span className="font-bold">{clickedRowData.active === true ? 'Inactive' : 'Active'}</span> this Common Product Master?
				</DialogContentText>
			</DialogContent>
			<DialogActions>
				<Button
...
export default CommonProductMasterFormActiveAlertForm;
