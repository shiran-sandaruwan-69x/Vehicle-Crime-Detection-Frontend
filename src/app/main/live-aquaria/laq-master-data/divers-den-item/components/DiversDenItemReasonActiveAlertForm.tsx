...
import { ReasonModifiedData } from '../../cancel-order-reasons/cancel-order-reason-types/CancelOrderReasonTypes';
...
function DiversDenItemReasonActiveAlertForm({ toggleModal, isOpen, clickedRowData, handleAlertForm }: Props) {
	return (
		<Dialog
			open={isOpen}
			onClose={toggleModal}
		>
			...
			<DialogContent>
				<DialogContentText className="text-[10px] sm:text-[12px] lg:text-[14px]">
					...
					Divers Den Item Deletion Reason?
				</DialogContentText>
			</DialogContent>
			<DialogActions>
				<Button
...
export default DiversDenItemReasonActiveAlertForm;
