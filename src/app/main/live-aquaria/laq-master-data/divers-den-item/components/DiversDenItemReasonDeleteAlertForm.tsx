...
import { DiversDenItemDeleteReasonModifiedData } from '../divers-den-item-types/DiversDenItemTypes';
...
function DiversDenItemReasonDeleteAlertForm({ toggleModal, isOpen, clickedRowData, handleAlertForm }: Props) {
	return (
		<Dialog
			open={isOpen}
			onClose={toggleModal}
		>
			...
			<DialogContent>
				<DialogContentText className="text-[10px] sm:text-[12px] lg:text-[14px]">
					Are you sure you want to delete this Divers Den Item Deletion Reason?
				</DialogContentText>
			</DialogContent>
			<DialogActions>
				<Button
...
export default DiversDenItemReasonDeleteAlertForm;
