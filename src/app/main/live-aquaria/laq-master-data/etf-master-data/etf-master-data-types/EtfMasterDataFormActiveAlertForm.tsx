...
import { ItemDetailsModifiedData } from './ETFMasterDataTypes';
...
function EtfMasterDataFormActiveAlertForm({ toggleModal, isOpen, clickedRowData, handleAlertForm }: Props) {
	return (
		<Dialog
			open={isOpen}
			onClose={toggleModal}
		>
			...
			<DialogContent>
				<DialogContentText>
					...
					<span className="font-bold">{clickedRowData.active === true ? 'Inactive' : 'Active'}</span> this ETF
					Master Data?
				</DialogContentText>
			</DialogContent>
			<DialogActions>
...
export default EtfMasterDataFormActiveAlertForm;
