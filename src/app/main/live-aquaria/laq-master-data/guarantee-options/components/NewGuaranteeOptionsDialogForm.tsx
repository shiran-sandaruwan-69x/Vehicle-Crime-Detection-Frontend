...
import { createGuaranteeOptions } from '../../../../../axios/services/live-aquaria-services/master-data-services/MasterDataServices';
import TextFormField from '../../../../../common/FormComponents/FormTextField';
import { GuaranteeOptions } from '../guarantee-options-types/GuaranteeOptions';
...
function NewGuaranteeOptionsDialogForm({ toggleModal, isOpen, getAllGuaranteeOptions, compType }: Props) {
	...
	const onSubmit = async (values: GuaranteeOptions) => {
		...
		try {
			const response = await createGuaranteeOptions(data);
...
export default NewGuaranteeOptionsDialogForm;
