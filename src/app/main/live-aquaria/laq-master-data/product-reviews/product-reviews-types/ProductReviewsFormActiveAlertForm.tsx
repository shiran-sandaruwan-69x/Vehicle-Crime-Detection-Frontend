...
import { ItemDetailsModifiedData } from './ProductReviewsTypes';
...
function ProductReviewFormActiveAlertForm({ toggleModal, isOpen, clickedRowData, handleAlertForm }: Props) {
	return (
		<Dialog
			open={isOpen}
			onClose={toggleModal}
...
export default ProductReviewFormActiveAlertForm;
