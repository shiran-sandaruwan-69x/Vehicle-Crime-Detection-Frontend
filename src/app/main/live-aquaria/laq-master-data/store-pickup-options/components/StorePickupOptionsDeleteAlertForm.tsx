...
import { PickupOptionsModifiedData } from '../store-pickup-options-types/StorePickupOptionsTypes';
...
function StorePickupOptionsDeleteAlertForm({ toggleModal, isOpen, clickedRowData, handleAlertForm }: Props) {
	return (
		<Dialog
			open={isOpen}
			onClose={toggleModal}
		>
			...
			<DialogContent>
				<DialogContentText className="text-[10px] sm:text-[12px] lg:text-[14px]">
					Are you sure you want to delete this Store Pickup Option?
				</DialogContentText>
			</DialogContent>
			<DialogActions>
				<Button
...
export default StorePickupOptionsDeleteAlertForm;
