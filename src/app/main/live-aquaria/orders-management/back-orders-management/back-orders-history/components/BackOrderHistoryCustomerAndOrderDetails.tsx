...
function BackOrderHistoryCustomerAndOrderDetails({ toggleModal, order }: Props) {
	return (
			...
			>
				...
				>
					<h6 className="text-[12px] lg:text-[14px] mb-[4px]">
						<span className="inline-block min-w-[110px] font-600">Order ID</span> : {order?.order?.order_no}
					</h6>
					<h6 className="text-[12px] lg:text-[14px] mb-[4px]">
						<span className="inline-block min-w-[110px] font-600">Order Date</span> : {order?.created_at}
					</h6>
					<h6 className="text-[12px] lg:text-[14px] mb-[4px]">
					...
					<h6 className="text-[12px] lg:text-[14px] mb-[4px]">
						<span className="inline-block min-w-[110px] font-600">Store Pickup</span> :{' '}
						{order?.pickup_option?.option}
					</h6>
					<h6 className="text-[12px] lg:text-[14px] mb-[4px]">
						<span className="inline-block min-w-[110px] font-600">Recurring Order</span> : 'dummy'
					</h6>
				</Grid>
				<Grid
					item
				...
				>
					<h6 className="text-[12px] lg:text-[14px] mb-[4px]">
						...
						<br />
						{order?.order?.billing_address?.address_line_2}, {order?.order?.billing_address?.city}
						<br />
				...
				>
					<h6 className="text-[12px] lg:text-[14px] mb-[4px]">
						...
						<br />
						{order?.order?.shipping_address?.address_line_2}, {order?.order?.shipping_address?.city}
						<br />
...
export default BackOrderHistoryCustomerAndOrderDetails;
