...
function BackOrdersEditAlertForm({ toggleModal, isOpen, clickedRowData, handleAlertForm, seletedOldData }: Props) {
	...
	return (
		...
		>
			<Formik
				initialValues={{
					credit_points: `$ ${parseInt(clickedRowData?.unitPrice) * (parseInt(seletedOldData?.quantity) - parseInt(clickedRowData?.quantity))}`
				}}
				onSubmit={null}
...
export default BackOrdersEditAlertForm;
