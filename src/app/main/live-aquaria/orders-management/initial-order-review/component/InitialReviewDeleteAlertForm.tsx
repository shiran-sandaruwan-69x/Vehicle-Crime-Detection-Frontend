...
import { ORDER_PLANING_DELETE_ITEM } from 'src/app/axios/services/AdminServices';
...
function InitialReviewDeleteAlertForm({ toggleModal, isOpen, clickedRowData }: Props) {
	...
	return (
		...
		>
			<Formik
				...
				onSubmit={async (values: { delete_reason: string }) => {
					try {
						await axios.post(
							`${ORDER_PLANING_DELETE_ITEM}${clickedRowData.shipment_id}/items/${clickedRowData.id}`,
							{
...
export default InitialReviewDeleteAlertForm;
