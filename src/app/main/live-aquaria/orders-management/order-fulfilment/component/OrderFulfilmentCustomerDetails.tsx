...
function OrderFulfilmentCustomerDetails({ toggleModal, order }: Props) {
			...
			>
				...
				>
					<h6 className="text-[12px] lg:text-[14px] mb-[4px]">
						<span className="inline-block min-w-[110px] font-600">OP Number</span> : {order?.order?.order_no}
					</h6>
					<h6 className="text-[12px] lg:text-[14px] mb-[4px]">
					...
					<h6 className="text-[12px] lg:text-[14px] mb-[4px]">
						<span className="inline-block min-w-[110px] font-600">UPS Tracking Number</span> :{' '}
...
export default OrderFulfilmentCustomerDetails;
