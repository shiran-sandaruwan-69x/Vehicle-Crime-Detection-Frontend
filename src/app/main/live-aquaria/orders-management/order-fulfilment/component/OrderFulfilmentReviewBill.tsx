...
import { OrderFullfillmentObject } from '../interfaces';
...
function OrderFulfilmentReviewBill({ isOpen, toggleModal, clickedRowData }: InitialOrderReviewBillProps) {
...
export default OrderFulfilmentReviewBill;
