...
function AssignPickerCustomerAndOrderDetails({ toggleModal, order }: Props) {
	return (
		<div className="min-w-full max-w-[100vw]">
			...
			>
				...
				>
					...
					<h6 className="text-[12px] lg:text-[14px] mb-[4px]">
						<span className="inline-block min-w-[110px] font-600">Recurring Order</span> : {order?.order?.is_auto_place_order === 1 ? "YES" : "NO"}
					</h6>
				</Grid>
				<Grid
					item
...
export default AssignPickerCustomerAndOrderDetails;
