...
import {
	...
	OrderShipmentItem
} from '../../../order-planning-management/order-planning/interfaces';
...
function AssignPickerOrderItemDetails({ toggleModal, order }: Props) {
...
export default AssignPickerOrderItemDetails;
