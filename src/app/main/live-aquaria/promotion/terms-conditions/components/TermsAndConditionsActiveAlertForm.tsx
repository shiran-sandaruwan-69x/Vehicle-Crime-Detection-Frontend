...
import { ShippingMethodsModifiedData } from '../../../shipping/shipping-methods/types/ShippingMethodsType';
...
function TermsAndConditionsActiveAlertForm({ toggleModal, isOpen, clickedRowData, handleAlertForm }: Props) {
	return (
		<Dialog
			open={isOpen}
			onClose={toggleModal}
...
export default TermsAndConditionsActiveAlertForm;
