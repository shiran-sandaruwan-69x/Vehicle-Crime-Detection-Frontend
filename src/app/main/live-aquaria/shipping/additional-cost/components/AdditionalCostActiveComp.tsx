...
import { StandardShippingCostModifiedData } from '../additional-cost-types/AdditionalCostTypes';
...
function AdditionalCostActiveComp({ toggleModal, isOpen, clickedRowData, handleAlertForm, activeText }: Props) {
	return (
		<Dialog
			open={isOpen}
			onClose={toggleModal}
...
export default AdditionalCostActiveComp;
