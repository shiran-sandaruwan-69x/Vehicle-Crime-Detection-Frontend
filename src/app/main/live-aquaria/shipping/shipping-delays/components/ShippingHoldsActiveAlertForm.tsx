...
import { ShippingMethodsModifiedData } from '../../shipping-methods/types/ShippingMethodsType';
...
function ShippingHoldsActiveAlertForm({ toggleModal, isOpen, clickedRowData, handleAlertForm }: Props) {
	return (
		<Dialog
			open={isOpen}
			onClose={toggleModal}
...
export default ShippingHoldsActiveAlertForm;
