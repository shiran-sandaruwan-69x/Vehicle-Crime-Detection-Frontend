...
import { ShippingMethodsModifiedData } from '../types/ShippingMethodsType';
...
function ShippingMethodsDeleteAlertForm({ toggleModal, isOpen, clickedRowData, handleAlertForm }: Props) {
	return (
		<Dialog
			open={isOpen}
			onClose={toggleModal}
...
export default ShippingMethodsDeleteAlertForm;
