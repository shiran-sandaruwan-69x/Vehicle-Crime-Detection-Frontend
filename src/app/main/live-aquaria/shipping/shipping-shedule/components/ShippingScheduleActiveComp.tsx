...
import { ShippingScheduleModifiedData } from '../../shipping-types/types/ShippingTypes';
...
function ShippingScheduleActiveComp({ toggleModal, isOpen, clickedRowData, handleAlertForm }: Props) {
	return (
		<Dialog
			open={isOpen}
			onClose={toggleModal}
...
export default ShippingScheduleActiveComp;
