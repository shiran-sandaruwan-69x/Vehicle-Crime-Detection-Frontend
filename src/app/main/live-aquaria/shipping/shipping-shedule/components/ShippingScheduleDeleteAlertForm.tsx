...
import { ShippingTypeModifiedData } from '../../shipping-types/types/ShippingTypes';
...
function ShippingScheduleDeleteAlertForm({ toggleModal, isOpen, clickedRowData, handleAlertForm }: Props) {
	return (
		<Dialog
			open={isOpen}
			onClose={toggleModal}
		>
			...
			<DialogContent>
				<DialogContentText className="text-[10px] sm:text-[12px] lg:text-[14px]">
					Are you sure you want to delete this Shipping Schedule?
				</DialogContentText>
			</DialogContent>
			<DialogActions>
				<Button
...
export default ShippingScheduleDeleteAlertForm;
